...
# Usage: curl -sSL https://raw.githubusercontent.com/nkrishna0495-rgb/My-Agent/main/install.sh | bash
...
pip install --upgrade bizclippy 2>/dev/null || {
    ...
    TMP_DIR=$(mktemp -d)
    git clone --depth 1 https://github.com/nkrishna0495-rgb/My-Agent.git "$TMP_DIR" 2>/dev/null || {
